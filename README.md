...
- WhatsApp ahora reconoce alias más tolerantes: EMITIR, EMITIR_ADMINISTRATIVO, POLIZA, SEGURO, EMITIRYAFILIACION, EMITIRAFILIACION, AFILIACION y MYR.
- Si el usuario escribe algo que no es comando y no hay formulario iniciado, responde: "Comando incorrecto. Para iniciar emisión manda la palabra clave: EMITIR...".
- Si el usuario escribe HOLA, solo saluda y espera instrucción, sin iniciar captura.
